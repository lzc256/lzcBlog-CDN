...
var _createClass = function () {
	...
	CTPlayer = function () {
		function a(b) {
			...
			"file" === this.type ? (this.root.innerHTML = this.template(), this.init(), this.bind(), this.isReady = !0) : "cloud" === this.type && (this.root.innerHTML = '<p class="CTPlayer-tip-loading"><span></span> <span></span> <span></span> <span></span><span></span></p>', Util.ajax({
		...
		return _createClass(a, [{
			...
			value: function () {
				...
				$("#musicmobbtn svg").removeClass("dong")
			}
		}, {
			key: "toggle",
			value: function () {
